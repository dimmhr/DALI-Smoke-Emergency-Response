...
:-dynamic evac_request/2.

eve(start_evacuation(var_R,var_L)):-write('EVACUATOR: received evacuation order for room '),write(var_R),nl,assert(evac_request(var_R,var_L)).

evi(evac_request(var_R,var_L)):-retract(evac_request(var_R,var_L)),write('EVACUATOR: evacuating room '),write(var_R),nl,write('EVACUATOR: unlocking doors'),nl,write('EVACUATOR: turning siren ON'),nl,a(message(safetyManager,send_message(room_safe(var_R),var_Me))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_315895,var_Ontology,_315899),_315889),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_315933)),a(message(var_Ag,propose(var_A,[_315933],var_AgI))),retractall(ext_agent(var_Ag,_315971,var_Ontology,_315975)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_315769,var_Ontology,_315773),_315763),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_315839,var_Ontology,_315843)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_315657,var_Ontology,_315661),_315651),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_315713,var_Ontology,_315717)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_315221),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_315255),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_315037).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_314885),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_314833),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_314709,_314711)),clause(agente(_314731,_314733,_314735,var_S),_314727),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_314503,_314505,_314507,var_S),_314499),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_314603,[]),repeat,read(_314603,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_314603).
