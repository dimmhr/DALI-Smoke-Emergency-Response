...
eve(new_smoke(var_L,var_R)):-write('SENSOR: smoke level = '),write(var_L),write('in Room '),write(var_R),nl,assertz(smoke_received(var_L,var_R)),eve(fire_alarm(var_L,var_R)).

eve(fire_alarm(var_L,var_R)):-threshold(var_Th),var_L>=var_Th,write('ALARM: smoke level is above threshold'),nl.

trigger_manager(var_L,var_R):-assert(smoke_received(var_L,var_R)).

evi(smoke_received(var_L,var_R)):-write('communicate with safetyManager.'),a(message(safetyManager,send_message(alarm(var_L,var_R),var_Me))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_318559,var_Ontology,_318563),_318553),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_318597)),a(message(var_Ag,propose(var_A,[_318597],var_AgI))),retractall(ext_agent(var_Ag,_318635,var_Ontology,_318639)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_318433,var_Ontology,_318437),_318427),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_318503,var_Ontology,_318507)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_318321,var_Ontology,_318325),_318315),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_318377,var_Ontology,_318381)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_317885),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_317919),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_317701).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_317549),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_317497),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_317373,_317375)),clause(agente(_317395,_317397,_317399,var_S),_317391),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_317167,_317169,_317171,var_S),_317163),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_317267,[]),repeat,read(_317267,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_317267).
